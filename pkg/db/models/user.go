...
var UserWhere = struct {
	...
	ID:       whereHelperint32{field: "`user`.`id`"},
...
var (
	...
	userColumnsWithoutDefault = []string{"id", "name", "password"}
...
func FindUser(ctx context.Context, exec boil.ContextExecutor, iD int32, selectCols ...string) (*User, error) {
	userObj := &User{}
...
func UserExists(ctx context.Context, exec boil.ContextExecutor, iD int32) (bool, error) {
	var exists bool
