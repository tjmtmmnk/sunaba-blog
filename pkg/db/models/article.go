...
var ArticleWhere = struct {
	...
	ID:      whereHelperint32{field: "`article`.`id`"},
...
var (
	articleAllColumns            = []string{"id", "title", "content"}
	articleColumnsWithoutDefault = []string{"id", "title", "content"}
...
func FindArticle(ctx context.Context, exec boil.ContextExecutor, iD int32, selectCols ...string) (*Article, error) {
	articleObj := &Article{}
...
func ArticleExists(ctx context.Context, exec boil.ContextExecutor, iD int32) (bool, error) {
	var exists bool
